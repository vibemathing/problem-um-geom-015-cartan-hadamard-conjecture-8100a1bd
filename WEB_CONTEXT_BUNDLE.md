...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-geom-015-cartan-hadamard-conjecture-8100a1bd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GEOM-015"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-geom-015-cartan-hadamard-conjecture-8100a1bd-v1",
      "problem_contract_sha256": "69983b65bf4f362c4fea8bb55d015baaca29601f051b25eb9a3fa4c77b69f0a4",
      "problem_id": "problem:um-geom-015-cartan-hadamard-conjecture-8100a1bd",
      "route_id": "route:um-geom-015-cartan-hadamard-conjecture-8100a1bd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-geom-015-cartan-hadamard-conjecture-8100a1bd-source-fidelity-01",
      "graph_id": "graph:um-geom-015-cartan-hadamard-conjecture-8100a1bd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-geom-015-cartan-hadamard-conjecture-8100a1bd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-geom-015-cartan-hadamard-conjecture-8100a1bd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does the isoperimetric inequality extend to Cartan-Hadamard manifolds (complete simply-connected manifolds of nonpositive curvature)?"
          },
          "statement_sha256": "a864116ac744b111a142eb591f24ab43fff4301fd1c2b7e7808e38b49046267d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-geom-015-cartan-hadamard-conjecture-8100a1bd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-geom-015-cartan-hadamard-conjecture-8100a1bd-root",
      "route_id": "route:um-geom-015-cartan-hadamard-conjecture-8100a1bd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-geom-015-138ee51e7efb",
        "url": "https://www.unsolvedmath.com/problems/GEOM-015"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
